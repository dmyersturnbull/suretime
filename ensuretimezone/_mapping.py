...
from ensuretimezone._model import TaggedDatetime, TaggedDuration
...
class TimezoneMap:
    ...
    def tagged_duration(self, start: TaggedDatetime, end: TaggedDatetime) -> TaggedDuration:
        return TaggedDuration(start, end)
    ...
    def get_zone_with_territory(self, zone: str, territory: Optional[str]) -> FrozenSet[ZoneInfo]:
        self._ensure()
