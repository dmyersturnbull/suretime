...
from suretime._utils import TzUtils, Clock, ClockTime, ClockInfo, SysTzInfo, NtpTime, NtpClockType
    ...
    def _get_now(
        ...
        if ntp_server is not None:
            if ntp_clock is None:
                raise AssertionError(f"ntp_attribute must be non-None if ntp_server is non-None")
            clock_time = TzUtils.get_ntp_clock(ntp_server, ntp_clock)
        else:
            clock_time = TzUtils.get_clock_time()
